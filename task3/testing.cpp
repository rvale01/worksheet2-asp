...
DEFINE_TEST_G(BumpTest1, BumpDown){
    BumpAllocatorDown<6*sizeof(int)> bumper; //creating an object of size 24
...
DEFINE_TEST_G(BumpTest2, BumpDown){
    BumpAllocatorDown<6*sizeof(char)> bumper; //creating an object of size 6
...
DEFINE_TEST_G(BumpTest3, BumpDown){
    BumpAllocatorDown<6*sizeof(int)> bumper;//creating an object of size 24
...
DEFINE_TEST_G(BumpTest4, BumpDown){
    BumpAllocatorDown<6*sizeof(char)> bumper; //creating an object of size 6
...
DEFINE_TEST_G(BumpTest5, BumpDown){
    BumpAllocatorDown<6*sizeof(int)> bumper; //creating an object of size 24
...
// trying to reallocate when the allocation_counter is not 0 and space is full
DEFINE_TEST_G(BumpTest6, BumpDown){
    BumpAllocatorDown<6*sizeof(char)> bumper; //creating an object of size 6
...
DEFINE_TEST_G(BumpTest7, BumpDown){
    BumpAllocatorDown<6*sizeof(int)> bumper; //creating an object of size 24
...
// deallocating and reallocating values
DEFINE_TEST_G(BumpTest8, BumpDown){
